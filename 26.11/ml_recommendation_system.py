...
def extract_perfume_features(perfume: Dict) -> np.ndarray:
    ...
    7. Price (1 feature): Log-normalized price
       - Scale: 0-1 (log scale to handle wide price ranges)
    
    Args:
        perfume: Dictionary containing perfume data from API
    
    Returns:
        numpy array of shape (40,) containing numerical features
    ...
    # Price - log normalized to handle wide range of prices
    # Most perfumes range from $20-500, we compress this with log scale
